...
primer Euler, glej \cite{euler49}. % ključ: euler
...
leta 1693, glej \cite, in jih je moč najti v knjigi \cite
iz leta 1982. Število normalnih kvadratov reda 5 je izračunal
R. Schroeppel leta 1973 (glej Gardner \cite).
Natančno število vseh različnih normalnih magičnih kvadratov reda 6 ni znano.
Avtorja navedenega približka sta Pinn in Wieczerkowski (glej \cite), ki
